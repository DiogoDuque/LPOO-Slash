...
public class Slash extends ApplicationAdapter implements InputProcessor {
    SpriteBatch batch;
    Sprite sprite;
    Texture img;
    World world;
    ...
    public void create() {
        ...
        world = new World(new Vector2(0, 0),true); //Vector2(0, 0)->sem gravidade
...
//                h-10/PIXELS_TO_METERS);
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        body.applyForceToCenter(50f, -100f, true);
